...
import { ShieldCheck, Store, Users, CreditCard, ArrowUpRight, CheckCircle2, XCircle, Search, Settings, Building2, RefreshCw } from "lucide-react";
...
export default function SuperAdminPage() {
    ...
    useEffect(() => {
        // Fetch global super admin statistics
    ...
    const handleSwitchToStore = (storeName: string) => {
        ...
        alert(`✅ Do'kon almashtirildi: "${storeName}" boshqaruv paneliga o'tilmoqda...`);
        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-wrap justify-between items-center bg-gradient-to-r from-purple-900 via-indigo-900 to-slate-900 p-8 rounded-3xl text-white shadow-2xl relative overflow-hidden">
                <div className="relative z-10 space-y-2">
                    ...
                    <h1 className="text-3xl font-black tracking-tight">Barcha Tizimlar va Do'konlar Boshqaruvi</h1>
                    <p className="text-purple-200 text-sm font-medium">Barcha do'konlar, foydalanuvchilar va tizim sozlamalarini yagona joydan nazorat qiling</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm space-y-3">
                    ...
                    <p className="text-xs text-emerald-600 font-bold flex items-center gap-1">
                        <ArrowUpRight size={14} /> +2 ta yangi bu oy
                    </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm space-y-3">
                    ...
                    <p className="text-xs text-emerald-600 font-bold flex items-center gap-1">
                        <ArrowUpRight size={14} /> +12% faollik
                    </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm space-y-3">
                    ...
                    <p className="text-xs text-emerald-600 font-bold flex items-center gap-1">
                        <ArrowUpRight size={14} /> Barcha do'konlar aylanmasi
                    </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm space-y-3">
                    ...
                    <p className="text-3xl font-black text-slate-800">3 ta PRO / 1 ta Trial</p>
                    <p className="text-xs text-gray-400 font-medium">98% barqaror ishlamoqda</p>
                </div>
            </div>

            {/* Store Selection & Management Table */}
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden space-y-4">
                <div className="p-6 border-b border-gray-50 flex flex-wrap justify-between items-center gap-4">
                    <div>
                        <h2 className="text-xl font-black text-slate-800">Do'konlar Ro'yxati va Context Switcher</h2>
                        <p className="text-xs text-gray-400 font-medium">Istalgan do'kon profiliga 1 ta klik bilan o'ting</p>
                    </div>
                    ...
                    <div className="relative w-72">
                        ...
                        <input
                            type="text"
                            placeholder="Do'kon yoki ega ismi bo'yicha qidirish..."
                            value={searchQuery}
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-gray-50 text-[10px] uppercase text-gray-400 font-black tracking-wider">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-center">Boshqaruv / O'tish</th>
                            </tr>
                        </thead>
