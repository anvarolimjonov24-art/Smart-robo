    ...
    if (loading) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
                <RefreshCw className="animate-spin text-purple-600 mb-2" size={36} />
                <p className="text-sm font-bold text-gray-500">Super Admin Platform Management yuklanmoqda...</p>
            </div>
        );
    }
